...
exports["default"] = {
    getMessages: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var conversationId, messages, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, app_1.prisma.message.findMany({
                            where: {
    ...
    newMessage: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, conversationId, senderId, content, message, err_2;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!conversationId || !senderId || !content)
                        return [2 /*return*/, res.status(500).json({ message: "Data not provided." })];
                    return [4 /*yield*/, app_1.prisma.message.create({
                            data: {
                                content: content,
